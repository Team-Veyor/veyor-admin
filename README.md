...
- **스타일: veyor-app 디자인 시스템 일치** — Tailwind v4 + 디자인 토큰(`src/styles/tokens.generated.css`, 브랜드 `#09ba8e`) + SUIT 폰트 + 타이포 스케일. 프리미티브(`src/components/ui/`: Button·Badge·Callout)도 veyor-app 컴포넌트와 동일 톤.
